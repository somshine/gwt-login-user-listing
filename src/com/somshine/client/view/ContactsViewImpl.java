...
public class ContactsViewImpl<T> extends Composite implements ContactsView<T> {
  ...
  public void priceData(JsArray<StockData> prices) {
	  String body = "";
	  for (int i=0; i < prices.length(); i++) {
	    StockData price = prices.get(i);
	    body += "<tr><td>" + price.getSymbol() + "</td>";
	    body += "<td>" + price.getPrice() + "</td>";
	    body += "<td>" + price.getChange() + "</td></tr>";
	  }
	  tableData.setHTML(body);
  }
